      ...
      <div className="sm:flex hidden">
        {isUserLoggedIn ? (
          <div className="flex gap-3 md:gap-5">
            <Link href="/prompt" className="black_btn">Create Post</Link>
            <button type='button' onClick={() => { }} className="outline_button "> Sign Out</button>
            <Link href='/profile'>
          ...
          <>
            {providers && Object.values(providers).map((provider) => (
              <button type='button' key={provider.name} onClick={() => signIn(provider.div)} className='black_btn'>
                Sing In
